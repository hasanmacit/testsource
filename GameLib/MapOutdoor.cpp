...
bool CMapOutdoor::Initialize()
{
	...
	m_lpCharacterShadowMapTexture2 = NULL;
	m_lpCharacterShadowMapTexture3 = NULL;
	m_lpCharacterShadowMapTexture4 = NULL;
	m_lpCharacterShadowMapTexture5 = NULL;
	m_lpCharacterShadowMapRenderTargetSurface = NULL;
	m_lpCharacterShadowMapRenderTargetSurface2 = NULL;
	m_lpCharacterShadowMapRenderTargetSurface3 = NULL;
	m_lpCharacterShadowMapRenderTargetSurface4 = NULL;
	m_lpCharacterShadowMapRenderTargetSurface5 = NULL;
...
void CMapOutdoor::OnBeginEnvironment()
{
	...
	rkForest.SetWindStrength(VitesseVent);
}
