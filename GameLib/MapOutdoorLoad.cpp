...
#endif
{
	...
	_snprintf(szShadowTexName, sizeof(szShadowTexName), "shadowmap.dds");
	_snprintf(szShadowMapName, sizeof(szShadowMapName), "shadowmap.raw");
...
bool CMapOutdoor::LoadSetting(const char * c_szFileName)
{
	...
	D3DXMatrixScaling(&m_matDynamicShadowScale, 1.0f / 15000.0f, -1.0f / 15000.0f, 1.0f);
	m_matDynamicShadowScale._41 = 0.5f;
	m_matDynamicShadowScale._42 = 0.5f;

	D3DXMatrixScaling(&m_matDynamicShadowScale3, 1.0f / 25000.0f, -1.0f / 25000.0f, 1.0f);
	m_matDynamicShadowScale3._41 = 0.5f;
	m_matDynamicShadowScale3._42 = 0.5f;

	if (Frustum::Instance().shadowType == 2)
	{
		D3DXMatrixScaling(&m_matDynamicShadowScale5, 1.0f / 35000.0f, -1.0f / 35000.0f, 1.0f);
		m_matDynamicShadowScale5._41 = 0.5f;
		m_matDynamicShadowScale5._42 = 0.5f;
	}
	else
	{
		D3DXMatrixScaling(&m_matDynamicShadowScale5, 1.0f / 15000.0f, -1.0f / 15000.0f, 1.0f);
		m_matDynamicShadowScale5._41 = 0.5f;
		m_matDynamicShadowScale5._42 = 0.5f;
	}
