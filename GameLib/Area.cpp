...
CMemoryPool<CArea::TObjectInstance>	CArea::ms_ObjectInstancePool;
CMemoryPool<CAttributeInstance>		CArea::ms_AttributeInstancePool;
CMemoryPool<CArea::TAmbienceInstance>	CArea::ms_AmbienceInstancePool;
CMemoryPool<CDungeonBlock>				CArea::ms_DungeonBlockInstancePool;
CMemoryPool<CArea>						CArea::ms_kPool;
...
bool CArea::Load(const char * c_szPathName)
{
	...
	//TraceError("LoadArea: %s", strObjectDataFileName.c_str());
...
bool CArea::__Load_LoadObject(const char * c_szFileName)
{
	...
	for (DWORD i = 0; i < dwCount; ++i)
	{
		...
		if (std::strcmp(rVector[3].c_str(), "1337000209") == 0)
		{
			continue;
		}

#ifdef JTX_UNLOAD_GRASS
		if (Frustum::Instance().performanceMode == 2)
		{
			if (std::strcmp(rVector[3].c_str(), "1337464008") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000209") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000212") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000205") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000213") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000002") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000005") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464006") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464004") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464005") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000211") == 0
				|| std::strcmp(rVector[3].c_str(), "3012572638") == 0
				|| std::strcmp(rVector[3].c_str(), "3012572639") == 0
				//|| std::strcmp(rVector[3].c_str(), "1025956065") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464013") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464012") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000055") == 0 //Tree Map1 Red
				|| std::strcmp(rVector[3].c_str(), "1337000109") == 0 //Tree Yongsu
				|| std::strcmp(rVector[3].c_str(), "1337000069") == 0 //King galben mare
				|| std::strcmp(rVector[3].c_str(), "1104825488") == 0 //Azrael 6
				|| std::strcmp(rVector[3].c_str(), "1104825484") == 0 //Azrael 4
				|| std::strcmp(rVector[3].c_str(), "1104825483") == 0 //Azrael 3
				|| std::strcmp(rVector[3].c_str(), "1104825485") == 0 //Azrael 5
				|| std::strcmp(rVector[3].c_str(), "1337464011") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464020") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464021") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464015") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464018") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464017") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464026") == 0
				|| std::strcmp(rVector[3].c_str(), "485100226") == 0
				|| std::strcmp(rVector[3].c_str(), "485100223") == 0
				|| std::strcmp(rVector[3].c_str(), "485100228") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000214") == 0
				|| std::strcmp(rVector[3].c_str(), "485100222") == 0
				|| std::strcmp(rVector[3].c_str(), "30122372438") == 0
				//|| std::strcmp(rVector[3].c_str(), "221645431") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000001") == 0
				|| std::strcmp(rVector[3].c_str(), "3363030126") == 0
				|| std::strcmp(rVector[3].c_str(), "1337464024") == 0
				//|| std::strcmp(rVector[3].c_str(), "57601366") == 0
				|| std::strcmp(rVector[3].c_str(), "703244764") == 0 //stones
				|| std::strcmp(rVector[3].c_str(), "398429981") == 0
				|| std::strcmp(rVector[3].c_str(), "595597888") == 0 //stone
				|| std::strcmp(rVector[3].c_str(), "3562432892") == 0 //bambus
				|| std::strcmp(rVector[3].c_str(), "1659694080") == 0 //bambus
				|| std::strcmp(rVector[3].c_str(), "939251476") == 0 //bambus
				|| std::strcmp(rVector[3].c_str(), "31326565") == 0 //peste
				|| std::strcmp(rVector[3].c_str(), "3208726760") == 0 //peste
				|| std::strcmp(rVector[3].c_str(), "31326567") == 0 //peste
				|| std::strcmp(rVector[3].c_str(), "31326566") == 0 //peste
				|| std::strcmp(rVector[3].c_str(), "1337464022") == 0)
			{
				continue;
			}

		}
		if (Frustum::Instance().performanceMode == 1)
		{
			if (std::strcmp(rVector[3].c_str(), "1337464008") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000209") == 0
				|| std::strcmp(rVector[3].c_str(), "1337000212") == 0
		...
		if (Frustum::Instance().performanceMode == 0)
		{
			if (std::strcmp(rVector[3].c_str(), "1337000082") == 0 ||
			std::strcmp(rVector[3].c_str(), "2570994768") == 0)
				continue;			
		}
		...
		{
			if (std::strcmp(rVector[3].c_str(), "1253733280") == 0
				|| std::strcmp(rVector[3].c_str(), "3355874121") == 0
				|| std::strcmp(rVector[3].c_str(), "1178450968") == 0)
				continue;
		}
...
//			Tracef("%d : %f\n", iPlaySoundIndex, __GetVolumeFromDistance(fDistance));
			CSoundManager::Instance().SetSoundVolume3D(fx, fy, fz, iPlaySoundIndex, __GetVolumeFromDistance(fDistance));
		}
	}
	else
	{
...
float CArea::TAmbienceInstance::__GetVolumeFromDistance(float fDistance)
{
	...
	// Get the volume set by the slider
	float sliderVolume = CSoundManager::Instance().GetEffectsVolume();

	// Calculate the maximum volume radius
	float fMaxVolumeAreaRadius = float(dwRange) / 16;

	if (CPythonBackground::Instance().SelectRain == 16 || CPythonBackground::Instance().SelectRain == 25 || CPythonBackground::Instance().SelectRain == 8)
	{
		sliderVolume = 0.0f;
		fMaxVolumeAreaRadius = 0.0f;
	}

	//TraceError("fMaxVolumeAreaRadius: %f", fMaxVolumeAreaRadius);

	// If the distance is beyond the range, return zero volume
	if (fDistance > dwRange)
		return 0.0f;

	// Calculate the base volume based on the slider setting
	float baseVolume = sliderVolume;

	// Adjust the volume based on distance
	float distanceFactor = fDistance / dwRange;
	float volumeReduction = distanceFactor * baseVolume;

	// Final volume is the base volume reduced by the distance factor
	return max(0.0f, baseVolume - volumeReduction);
}
