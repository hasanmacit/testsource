...
public:
	...
	void            SnapShadowSpaceMatrix(D3DXMATRIX& mat, float spaceSize);

	void			SkyUtil();

	bool			BeginRenderCharacterShadowToTexture();
	bool			BeginRenderCharacterShadowToTexture2();
	bool			BeginRenderCharacterShadowToTexture3();
	bool			BeginRenderCharacterShadowToTexture4();
	bool			BeginRenderCharacterShadowToTexture5();
	void			EndRenderCharacterShadowToTexture();
	void			EndRenderCharacterShadowToTexture2();
	void			EndRenderCharacterShadowToTexture3();
	void			EndRenderCharacterShadowToTexture4();
	void			EndRenderCharacterShadowToTexture5();
	bool			recreate = false;

	bool			BeginRenderCharacterShadowToTextureReload3();
	void			EndRenderCharacterShadowToTextureReload3();
...
#ifdef JTX_ENTIRE_TERRAIN_RENDER
...
protected:
	...
	D3DXMATRIX				ReflectedCameraPositionMatrix();
	D3DXVECTOR3				ReflectedCameraPositionVector3();
	void					LoadWaterTexture();
	void					UnloadWaterTexture();
	void					MapTextureReflection();
public:
...
protected:
	...
	// Character Shadow
public:
	LPDIRECT3DTEXTURE8 TextureReflectionMap;
	LPDIRECT3DTEXTURE8 m_lpCharacterShadowMapTexture;
	LPDIRECT3DTEXTURE8 m_lpCharacterShadowMapTexture2;
	LPDIRECT3DTEXTURE8 m_lpCharacterShadowMapTexture3;
	LPDIRECT3DTEXTURE8 m_lpCharacterShadowMapTexture4;
	LPDIRECT3DTEXTURE8 m_lpCharacterShadowMapTexture5;
	LPDIRECT3DSURFACE8 m_lpCharacterShadowMapRenderTargetSurface;
	LPDIRECT3DSURFACE8 m_lpCharacterShadowMapRenderTargetSurface2;
	LPDIRECT3DSURFACE8 m_lpCharacterShadowMapRenderTargetSurface3;
	LPDIRECT3DSURFACE8 m_lpCharacterShadowMapRenderTargetSurface4;
	LPDIRECT3DSURFACE8 m_lpCharacterShadowMapRenderTargetSurface5;
	LPDIRECT3DSURFACE8 m_lpCharacterShadowMapDepthSurface;
	LPDIRECT3DSURFACE8 m_lpCharacterShadowMapDepthSurfaceTree;
	D3DVIEWPORT8 m_ShadowMapViewport;
	D3DVIEWPORT8 m_ShadowMapViewportTree;
	WORD m_wShadowMapSize;
	LPDIRECT3DTEXTURE9 normalMap;

	//New Graphics
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderDepth = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderMain = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderTerrain = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderObjects = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderWater = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderMain2 = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderTerrain2 = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderObjects2 = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderWater2 = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderMain3 = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderTerrain3 = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderObjects3 = nullptr;
	LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderWater3 = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderDepth = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderMain = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderTerrain = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderObjects = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderWater = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderMain2 = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderTerrain2 = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderObjects2 = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderWater2 = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderMain3 = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderTerrain3 = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderObjects3 = nullptr;
	LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderWater3 = nullptr;
	D3DXMATRIX m_MatLightViewProj;
	D3DXMATRIX m_MatLightViewProj2;
	LPDIRECT3DVERTEXSHADER9 LoadAndBuildVertexShader(const char* filename);
	LPDIRECT3DPIXELSHADER9 LoadAndBuildPixelShader(const char* filename);
	...
	//////////
	bool isPinkEnvironment = false;
	bool isNoapteEnvironment = false;
	bool isEnvironment6 = false;
	bool isEnvironment7 = false;
	bool isEnvironment9 = false;
	bool isEnvironment10 = false;
	bool isEnvironment11 = false;
	bool isEnvironment2 = false;
	bool isEnvironment3 = false;
	bool isEnvironment4 = false;
	bool isEnvironment5 = false;
...
public:
	...
	D3DXMATRIX m_matDynamicShadow2;
	D3DXMATRIX m_matDynamicShadow3;
	D3DXMATRIX m_matDynamicShadow5;
	D3DXMATRIX m_matDynamicShadowScale;
	D3DXMATRIX m_matDynamicShadowScale2;
	D3DXMATRIX m_matDynamicShadowScale3;
	D3DXMATRIX m_matDynamicShadowScale5;
	D3DXMATRIX m_matLightView;
	D3DXMATRIX m_matLightView2;
	D3DXVECTOR3 current_v3SunPosition;
	D3DXVECTOR3 shadow_eye;
...
public:
	void __RenderTerrain_RenderHardwareTransformPatch2();
	void __RenderTerrain_RenderHardwareTransformPatch3();
...
public:
	void __HardwareTransformPatch_RenderPatchSplat2(long patchnum, WORD wPrimitiveCount, D3DPRIMITIVETYPE ePrimitiveType);
	void __HardwareTransformPatch_RenderPatchSplat3(long patchnum, WORD wPrimitiveCount, D3DPRIMITIVETYPE ePrimitiveType);
...
protected:
	CMemoryPool<CMonsterAreaInfo>		m_kPool_kMonsterAreaInfo;
