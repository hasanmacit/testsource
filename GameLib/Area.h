...
class CArea
{
	...
	protected:
		static CMemoryPool<TObjectInstance>			ms_ObjectInstancePool;
		static CMemoryPool<CAttributeInstance>			ms_AttributeInstancePool;
		static CMemoryPool<TAmbienceInstance>			ms_AmbienceInstancePool;
		static CMemoryPool<CDungeonBlock>				ms_DungeonBlockInstancePool;
	...
	public:
		...
		static CMemoryPool<CArea>		ms_kPool;
};
