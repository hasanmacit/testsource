const char* yellow_terrainShadowsPS = R"(
struct PS_INPUT
{
...
float4 main(PS_INPUT input) : SV_TARGET
{
    ...
    if (SpecularLight > 0.5f)
    {
        ...
        {     
            ...
            {
                float pointLightIntensity1 = ComputePointLightIntensity(input.WorldPos.xyz, pointLightPositionGalbeni[i], 4000.0f) * flicker;
                float pointLightIntensity2 = ComputePointLightIntensity(input.WorldPos.xyz, pointLightPositionGalbeni[i], 2000.0f) * flicker;
            ...
            {
                float pointLightIntensity1 = ComputePointLightIntensity(input.WorldPos.xyz, portalGalbeni[j], 8000.0f) * flicker;
                float pointLightIntensity2 = ComputePointLightIntensity(input.WorldPos.xyz, portalGalbeni[j], 4000.0f) * flicker;
                totalPointLightIntensity += pointLightIntensity1;
