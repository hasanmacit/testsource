...
namespace NRaceData
{
	...
	extern CMemoryPool<TCollisionData>			g_CollisionDataPool;
	extern CMemoryPool<TAttachingEffectData>	g_EffectDataPool;
	extern CMemoryPool<TAttachingObjectData>	g_ObjectDataPool;
};
