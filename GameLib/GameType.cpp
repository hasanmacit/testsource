...
CMemoryPool<NRaceData::TCollisionData>			NRaceData::g_CollisionDataPool;
CMemoryPool<NRaceData::TAttachingEffectData>	NRaceData::g_EffectDataPool;
CMemoryPool<NRaceData::TAttachingObjectData>	NRaceData::g_ObjectDataPool;
