...
CMemoryPool<CGraphicExpandedImageInstance> CGraphicExpandedImageInstance::ms_kPool;
...
void CGraphicExpandedImageInstance::OnRenderCoolTime(float fCoolTime)
{
	...
	float su = (c_rRect.left - m_TextureRenderingRect.left) * texReverseWidth;
	float sv = (c_rRect.top - m_TextureRenderingRect.top) * texReverseHeight;
	float eu = (c_rRect.right + m_TextureRenderingRect.right) * texReverseWidth;
	float ev = (c_rRect.bottom + m_TextureRenderingRect.bottom) * texReverseHeight;
