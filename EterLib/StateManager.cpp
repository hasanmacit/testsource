...
{
#ifdef DIRECTX9
	SetSamplerState(dwStage, D3DSAMP_MINFILTER, D3DTEXF_ANISOTROPIC);
	SetSamplerState(dwStage, D3DSAMP_MAGFILTER, D3DTEXF_ANISOTROPIC);
	SetSamplerState(dwStage, D3DSAMP_MIPFILTER, D3DTEXF_ANISOTROPIC);
#else
	...
	SetTextureStageState(dwStage, D3DTSS_MIPFILTER, D3DTEXF_ANISOTROPIC);
#endif
}
...
void CStateManager::SetDefaultState()
{
	...
	SetTextureStageState(1, D3DTSS_MINFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(1, D3DTSS_MAGFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(1, D3DTSS_MIPFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(2, D3DTSS_MINFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(2, D3DTSS_MAGFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(2, D3DTSS_MIPFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(3, D3DTSS_MINFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(3, D3DTSS_MAGFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(3, D3DTSS_MIPFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(4, D3DTSS_MINFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(4, D3DTSS_MAGFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(4, D3DTSS_MIPFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(5, D3DTSS_MINFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(5, D3DTSS_MAGFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(5, D3DTSS_MIPFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(6, D3DTSS_MINFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(6, D3DTSS_MAGFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(6, D3DTSS_MIPFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(7, D3DTSS_MINFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(7, D3DTSS_MAGFILTER, D3DTEXF_ANISOTROPIC);
	SetTextureStageState(7, D3DTSS_MIPFILTER, D3DTEXF_ANISOTROPIC);
...
bool CStateManager::LoadShader(const char* pszFilename, LPD3DXEFFECT& pEffect)
{
	...
	DWORD dwShaderFlags = D3DXFX_NOT_CLONEABLE | D3DXSHADER_NO_PRESHADER | D3DXSHADER_FORCE_PS_SOFTWARE_NOOPT;
