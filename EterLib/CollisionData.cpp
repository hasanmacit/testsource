...
*/
CMemoryPool<CSphereCollisionInstance> gs_sci;
CMemoryPool<CCylinderCollisionInstance> gs_cci;
CMemoryPool<CPlaneCollisionInstance> gs_pci;
CMemoryPool<CAABBCollisionInstance> gs_aci;
CMemoryPool<COBBCollisionInstance> gs_oci;
