...
static const std::size_t LARGE_PDT_VERTEX_BUFFER_SIZE = 768;
#endif
...
class CGraphicBase
{
	...
	public:
		...
		static bool SetPDTTextLineStream(SPDTVertexRaw* pSrcvertices, uint32_t uVtxCount);
#endif
...
public:
		static int						ms_fShadowIntensity;
		//static float					ms_fLeaves;
protected:
