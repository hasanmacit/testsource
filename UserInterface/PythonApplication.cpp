...
bool LoadLocaleData(const char* localePath)
{
	...
	snprintf(szSkillTableFileName, sizeof(szSkillTableFileName), "locale/ex/SkillTable.txt");
#else
...
#ifdef ENABLE_LOCALE_EX
	snprintf(szItemScale, sizeof(szItemScale), "locale/ex/item_scale.txt");
#else
