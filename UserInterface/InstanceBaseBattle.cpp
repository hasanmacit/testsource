...
#ifdef JTX_BLOOD
		if (Frustum::Instance().bloodLevel == 0)
		{
			if (!IsStone())
			{
				CEffectManager& rkEftMgr = CEffectManager::Instance();
				float fGrountHeight = CFlyingManager::Instance().GetMapManagerPtr()->GetHeight(m_GraphicThingInstance.m_v3Position.x, m_GraphicThingInstance.m_v3Position.y);
				float randomFloat = frandom(-10.0f, 50.0f);
				float randomFloat2 = frandom(-15.0f, -30.0f);
				float randomFlotRotation = frandom(0.0f, 360.0f);

				if (IsIceBlood())
				{
					if (frandom(0.0f, 1.0f) < 0.5f)  // 50% chance for each
					{
						rkEftMgr.CreateEffect("d:/ymir work/zone/plechi_env/halloween/effects/bloodIce/blood.mse", D3DXVECTOR3(m_GraphicThingInstance.m_v3Position.x + randomFloat, m_GraphicThingInstance.m_v3Position.y + randomFloat2, fGrountHeight), D3DXVECTOR3(0.0f, 0.0f, randomFlotRotation));
					}
					else
					{
						rkEftMgr.CreateEffect("d:/ymir work/zone/plechi_env/halloween/effects/bloodIce/bloodjtx.mse", D3DXVECTOR3(m_GraphicThingInstance.m_v3Position.x + randomFloat, m_GraphicThingInstance.m_v3Position.y + randomFloat2, fGrountHeight), D3DXVECTOR3(0.0f, 0.0f, randomFlotRotation));
					}
				}
				else if (IsTreeBlood())
				{
					if (frandom(0.0f, 1.0f) < 0.5f)  // 50% chance for each
					{
						rkEftMgr.CreateEffect("d:/ymir work/zone/plechi_env/halloween/effects/bloodTree/blood.mse", D3DXVECTOR3(m_GraphicThingInstance.m_v3Position.x + randomFloat, m_GraphicThingInstance.m_v3Position.y + randomFloat2, fGrountHeight), D3DXVECTOR3(0.0f, 0.0f, randomFlotRotation));
					}
					else
					{
						rkEftMgr.CreateEffect("d:/ymir work/zone/plechi_env/halloween/effects/bloodTree/bloodjtx.mse", D3DXVECTOR3(m_GraphicThingInstance.m_v3Position.x + randomFloat, m_GraphicThingInstance.m_v3Position.y + randomFloat2, fGrountHeight), D3DXVECTOR3(0.0f, 0.0f, randomFlotRotation));
					}
				}
				else
				{
					if (frandom(0.0f, 1.0f) < 0.5f)  // 50% chance for each
					{
						rkEftMgr.CreateEffect("d:/ymir work/zone/plechi_env/halloween/effects/blood.mse", D3DXVECTOR3(m_GraphicThingInstance.m_v3Position.x + randomFloat, m_GraphicThingInstance.m_v3Position.y + randomFloat2, fGrountHeight), D3DXVECTOR3(0.0f, 0.0f, randomFlotRotation));
					}
					else
					{
						rkEftMgr.CreateEffect("d:/ymir work/zone/plechi_env/halloween/effects/bloodjtx.mse", D3DXVECTOR3(m_GraphicThingInstance.m_v3Position.x + randomFloat, m_GraphicThingInstance.m_v3Position.y + randomFloat2, fGrountHeight), D3DXVECTOR3(0.0f, 0.0f, randomFlotRotation));
					}
				}
			}
		}
