...
PyObject* backgroundSetEnvironmentData(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (!CPythonSystem::instance().GetNightModeOption() && iIndex == CPythonBackground::DAY_MODE_DARK)
		iIndex = CPythonBackground::DAY_MODE_LIGHT;
#endif
...
PyObject* backgroundSetShadowTypeLevel(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetShadowTypeLevel(iLevel);
	return Py_BuildNone();
}

PyObject* backgroundSetVisibleLobbyLevel(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetVisibleLobbyLevel(iLevel);
	return Py_BuildNone();
}
...
PyObject* backgroundSetSpecularLevel(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetSpecularLevel(iLevel);
	return Py_BuildNone();
}

PyObject* backgroundSetBloodLevel(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetBloodLevel(iLevel);
	return Py_BuildNone();
}

PyObject* backgroundSetAmbianceEffectsLevel(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetAmbianceEffectsLevel(iLevel);
	return Py_BuildNone();
}


PyObject* backgroundSetDynamicLightLevel(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetDynamicLightLevel(iLevel);
	return Py_BuildNone();
}

PyObject* backgroundSetRainLevel(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetRainLevel(iLevel);
	return Py_BuildNone();
}

PyObject* backgroundSetShadowDistanceBehind(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetShadowDistanceBehind(iLevel);
	return Py_BuildNone();
}
...
PyObject* backgroundSetTerrainShadow(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetTerrainShadow(iLevel);
	return Py_BuildNone();
}

PyObject* backgroundSetCollisionLevel(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetCollisionLevel(iLevel);
	return Py_BuildNone();
}

PyObject* backgroundSetTreeShadow(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetTreeShadow(iLevel);
	return Py_BuildNone();
}

PyObject* backgroundSetPerformanceMode(PyObject* poSelf, PyObject* poArgs)
{
	int iLevel;
	if (!PyTuple_GetInteger(poArgs, 0, &iLevel))
		return Py_BadArgument();
	...
	CPythonBackground& rkBG = CPythonBackground::Instance();
	rkBG.SetPerformanceMode(iLevel);
	return Py_BuildNone();
}
#endif
...
{
	CPythonBackground& rkBG = CPythonBackground::Instance();
	return Py_BuildValue("i", rkBG.IsBoomMap());
}
#endif
...
void initBackground()
{
	static PyMethodDef s_methods[] =
	{
...
#if defined(ENABLE_ENVIRONMENT_EFFECT_OPTION)
		{ "ChangeEnvironmentData", backgroundSetEnvironmentData, METH_VARARGS },
		...
		{ "SetVisibleLobbyLevel", backgroundSetVisibleLobbyLevel, METH_VARARGS },
		{ "SetShadowDistanceBehind", backgroundSetShadowDistanceBehind, METH_VARARGS },
		{ "SetShadowTargetLevel", backgroundSetShadowTargetLevel, METH_VARARGS },
		{ "SetTerrainShadow", backgroundSetTerrainShadow, METH_VARARGS },
		{ "SetTreeShadow", backgroundSetTreeShadow, METH_VARARGS },
		{ "SetPerformanceMode", backgroundSetPerformanceMode, METH_VARARGS },
		{ "SetRainLevel", backgroundSetRainLevel, METH_VARARGS },
		{ "SetCollisionLevel", backgroundSetCollisionLevel, METH_VARARGS },
		{ "SetDynamicLightLevel", backgroundSetDynamicLightLevel, METH_VARARGS },
		{ "SetSpecularLevel", backgroundSetSpecularLevel, METH_VARARGS },
		{ "SetBloodLevel", backgroundSetBloodLevel, METH_VARARGS },
		{ "SetAmbianceEffectsLevel", backgroundSetAmbianceEffectsLevel, METH_VARARGS },
		{ "SetShadowTypeLevel", backgroundSetShadowTypeLevel, METH_VARARGS },
#endif
	...
	PyModule_AddIntConstant(poModule, "SHADOW_QUALITY_ULTRA", CPythonBackground::SHADOW_QUALITY_ULTRA);
	PyModule_AddIntConstant(poModule, "SHADOW_BEHIND_0", CPythonBackground::SHADOW_BEHIND_0);
	PyModule_AddIntConstant(poModule, "SHADOW_BEHIND_1", CPythonBackground::SHADOW_BEHIND_1);
	PyModule_AddIntConstant(poModule, "SHADOW_BEHIND_2", CPythonBackground::SHADOW_BEHIND_2);
	PyModule_AddIntConstant(poModule, "SHADOW_BEHIND_3", CPythonBackground::SHADOW_BEHIND_3);
	...
	PyModule_AddIntConstant(poModule, "TERRAIN_SHADOW_on", CPythonBackground::TERRAIN_SHADOW_on);
	PyModule_AddIntConstant(poModule, "TERRAIN_SHADOW_off", CPythonBackground::TERRAIN_SHADOW_off);
	PyModule_AddIntConstant(poModule, "TERRAIN_SHADOW_low", CPythonBackground::TERRAIN_SHADOW_low);
	PyModule_AddIntConstant(poModule, "TREE_SHADOW_on", CPythonBackground::TREE_SHADOW_on);
	PyModule_AddIntConstant(poModule, "TREE_SHADOW_off", CPythonBackground::TREE_SHADOW_off);
	PyModule_AddIntConstant(poModule, "TREE_SHADOW_high", CPythonBackground::TREE_SHADOW_high);
	PyModule_AddIntConstant(poModule, "TREE_SHADOW_all", CPythonBackground::TREE_SHADOW_all);
	PyModule_AddIntConstant(poModule, "PERFORMANCE_MODE_on", CPythonBackground::PERFORMANCE_MODE_on);
	PyModule_AddIntConstant(poModule, "PERFORMANCE_MODE_medium", CPythonBackground::PERFORMANCE_MODE_medium);
	PyModule_AddIntConstant(poModule, "PERFORMANCE_MODE_off", CPythonBackground::PERFORMANCE_MODE_off);
	PyModule_AddIntConstant(poModule, "RAIN_0", CPythonBackground::RAIN_0);
	PyModule_AddIntConstant(poModule, "RAIN_1", CPythonBackground::RAIN_1);
	PyModule_AddIntConstant(poModule, "RAIN_2", CPythonBackground::RAIN_2);
	PyModule_AddIntConstant(poModule, "RAIN_3", CPythonBackground::RAIN_3);
	PyModule_AddIntConstant(poModule, "COLLISION0", CPythonBackground::COLLISION0);
	PyModule_AddIntConstant(poModule, "COLLISION1", CPythonBackground::COLLISION1);
	PyModule_AddIntConstant(poModule, "COLLISION2", CPythonBackground::COLLISION2);
	PyModule_AddIntConstant(poModule, "DYNAMIC_LIGHT_off", CPythonBackground::DYNAMIC_LIGHT_off);
	PyModule_AddIntConstant(poModule, "DYNAMIC_LIGHT_on", CPythonBackground::DYNAMIC_LIGHT_on);
	PyModule_AddIntConstant(poModule, "DYNAMIC_LIGHT_low", CPythonBackground::DYNAMIC_LIGHT_low);
	PyModule_AddIntConstant(poModule, "SPECULAR_off", CPythonBackground::SPECULAR_off);
	PyModule_AddIntConstant(poModule, "SPECULAR_on", CPythonBackground::SPECULAR_on);
	PyModule_AddIntConstant(poModule, "BLOOD_off", CPythonBackground::BLOOD_off);
	PyModule_AddIntConstant(poModule, "BLOOD_on", CPythonBackground::BLOOD_on);
	PyModule_AddIntConstant(poModule, "AEFFECTS_off", CPythonBackground::AEFFECTS_off);
	PyModule_AddIntConstant(poModule, "AEFFECTS_on", CPythonBackground::AEFFECTS_on);
	PyModule_AddIntConstant(poModule, "SHADOWTYPE_on", CPythonBackground::SHADOWTYPE_on);
	PyModule_AddIntConstant(poModule, "SHADOWTYPE_soft", CPythonBackground::SHADOWTYPE_soft);
	PyModule_AddIntConstant(poModule, "SHADOWTYPE_off", CPythonBackground::SHADOWTYPE_off);
	PyModule_AddIntConstant(poModule, "SHADOWTYPE_close", CPythonBackground::SHADOWTYPE_close);
	PyModule_AddIntConstant(poModule, "VISIBLE_LOBBY_on", CPythonBackground::VISIBLE_LOBBY_on);
	PyModule_AddIntConstant(poModule, "VISIBLE_LOBBY_off", CPythonBackground::VISIBLE_LOBBY_off);
#endif
