...
PyObject* sndSetEffectsVolumef(PyObject* poSelf, PyObject* poArgs)
{
	float fVolume;
	if (!PyTuple_GetFloat(poArgs, 0, &fVolume))
		return Py_BuildException();
	...
	CSoundManager& rkSndMgr = CSoundManager::Instance();
	rkSndMgr.SetEffectsVolumeRatio(fVolume);
	return Py_BuildNone();
}
...
PyObject* sndSetEffectsScale(PyObject* poSelf, PyObject* poArgs)
{
	float fScale;
	if (!PyTuple_GetFloat(poArgs, 0, &fScale))
		return Py_BuildException();
	...
	CSoundManager& rkSndMgr = CSoundManager::Instance();
	rkSndMgr.SetEffectsScale(fScale);
	return Py_BuildNone();
}
...
void initsnd()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "SetEffectsVolumef",		sndSetEffectsVolumef,		METH_VARARGS },
		{ "SetSoundVolume",			sndSetSoundVolume,			METH_VARARGS },
		{ "SetSoundScale",			sndSetSoundScale,			METH_VARARGS },
		{ "SetSoundScale",			sndSetSoundScale,			METH_VARARGS },
		{ "SetEffectsScale",		sndSetEffectsScale,			METH_VARARGS },
