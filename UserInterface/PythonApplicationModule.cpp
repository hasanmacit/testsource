...
void initapp()
{
...
#ifdef ENABLE_LOCALE_EX
	PyModule_AddIntConstant(poModule, "ENABLE_LOCALE_EX",   1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LOCALE_EX",   0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_LEAVES_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_LEAVES", c_fDefaultLeaves);
	PyModule_AddIntConstant(poModule, "MIN_LEAVES", c_fMinLeaves);
	PyModule_AddIntConstant(poModule, "MAX_LEAVES", c_fMaxLeaves);

	PyModule_AddIntConstant(poModule, "ENABLE_SHADOW_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_SHADOW", c_fDefaultShadowIntensity);
	PyModule_AddIntConstant(poModule, "MIN_SHADOW", c_fMinShadowIntensity);
	PyModule_AddIntConstant(poModule, "MAX_SHADOW", c_fMaxShadowIntensity);

	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_SHOP", c_fDefaultShopDistance);
	PyModule_AddIntConstant(poModule, "MIN_SHOP", c_fMinShopDistance);
	PyModule_AddIntConstant(poModule, "MAX_SHOP", c_fMaxShopDistance);

	PyModule_AddIntConstant(poModule, "ENABLE_MOB_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_MOB", c_fDefaultMobDistance);
	PyModule_AddIntConstant(poModule, "MIN_MOB", c_fMinMobDistance);
	PyModule_AddIntConstant(poModule, "MAX_MOB", c_fMaxMobDistance);

	PyModule_AddIntConstant(poModule, "ENABLE_STONE_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_STONE", c_fDefaultStoneDistance);
	PyModule_AddIntConstant(poModule, "MIN_STONE", c_fMinStoneDistance);
	PyModule_AddIntConstant(poModule, "MAX_STONE", c_fMaxStoneDistance);

	PyModule_AddIntConstant(poModule, "ENABLE_PET_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_PET", c_fDefaultPetDistance);
	PyModule_AddIntConstant(poModule, "MIN_PET", c_fMinPetDistance);
	PyModule_AddIntConstant(poModule, "MAX_PET", c_fMaxPetDistance);

	PyModule_AddIntConstant(poModule, "ENABLE_MOUNT_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_MOUNT", c_fDefaultMountDistance);
	PyModule_AddIntConstant(poModule, "MIN_MOUNT", c_fMinMountDistance);
	PyModule_AddIntConstant(poModule, "MAX_MOUNT", c_fMaxMountDistance);

	PyModule_AddIntConstant(poModule, "ENABLE_NPC_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_NPC", c_fDefaultNpcDistance);
	PyModule_AddIntConstant(poModule, "MIN_NPC", c_fMinNpcDistance);
	PyModule_AddIntConstant(poModule, "MAX_NPC", c_fMaxNpcDistance);

	PyModule_AddIntConstant(poModule, "ENABLE_TEXT_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_TEXT", c_fDefaultTextDistance);
	PyModule_AddIntConstant(poModule, "MIN_TEXT", c_fMinTextDistance);
	PyModule_AddIntConstant(poModule, "MAX_TEXT", c_fMaxTextDistance);

	PyModule_AddIntConstant(poModule, "ENABLE_TEXT_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_EFFECT", c_fDefaultEFFECTDistance);
	PyModule_AddIntConstant(poModule, "MIN_EFFECT", c_fMinEffectDistance);
	PyModule_AddIntConstant(poModule, "MAX_EFFECT", c_fMaxEffectDistance);

	PyModule_AddIntConstant(poModule, "ENABLE_SHOPTEXT_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_SHOPTEXT", c_fDefaultShopTextDistance);
	PyModule_AddIntConstant(poModule, "MIN_SHOPTEXT", c_fMinShopTextDistance);
	PyModule_AddIntConstant(poModule, "MAX_SHOPTEXT", c_fMaxShopTextDistance);

	PyModule_AddIntConstant(poModule, "ENABLE_STONE_SCALE_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_STONE_SCALE", c_fDefaultStoneScale);
	PyModule_AddIntConstant(poModule, "MIN_STONE_SCALE", c_fMinStoneScale);
	PyModule_AddIntConstant(poModule, "MAX_STONE_SCALE", c_fMaxStoneScale);

	PyModule_AddIntConstant(poModule, "ENABLE_BOSS_SCALE_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_BOSS_SCALE", c_fDefaultBossScale);
	PyModule_AddIntConstant(poModule, "MIN_BOSS_SCALE", c_fMinBossScale);
	PyModule_AddIntConstant(poModule, "MAX_BOSS_SCALE", c_fMaxBossScale);

	PyModule_AddIntConstant(poModule, "ENABLE_MOUNT_SCALE_OPTION", 1);
	PyModule_AddIntConstant(poModule, "DEFAULT_MOUNT_SCALE", c_fDefaultMountScale);
	PyModule_AddIntConstant(poModule, "MIN_MOUNT_SCALE", c_fMinMountScale);
	PyModule_AddIntConstant(poModule, "MAX_MOUNT_SCALE", c_fMaxMountScale);
#endif
