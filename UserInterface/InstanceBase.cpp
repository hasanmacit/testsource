...
CMemoryPool<CInstanceBase> CInstanceBase::ms_kPool;
...
BOOL CInstanceBase::IsMainInstance()
{
	return m_GraphicThingInstance.IsMainInstance();
}

BOOL CInstanceBase::IsIceBlood()
{
	return m_GraphicThingInstance.IsIceBlood();
}

BOOL CInstanceBase::IsTreeBlood()
{
	return m_GraphicThingInstance.IsTreeBlood();
}
