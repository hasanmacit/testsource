...
//Shadow Intensity
constexpr float c_fDefaultLeaves = 1.0;
constexpr float c_fMinLeaves = 1.0;
constexpr float c_fMaxLeaves = 10.0;

//Shadow Intensity
constexpr int c_fDefaultShadowIntensity = 69;
constexpr int c_fMinShadowIntensity = 29;
constexpr int c_fMaxShadowIntensity = 99;

//SHOP Distance
constexpr float c_fDefaultShopDistance = 600.0f;
constexpr float c_fMinShopDistance = 0.0f;
constexpr float c_fMaxShopDistance = 10000.0f;

//SHOPTEXT Distance
constexpr float c_fDefaultShopTextDistance = 600.0f;
constexpr float c_fMinShopTextDistance = 0.0f;
constexpr float c_fMaxShopTextDistance = 10000.0f;

//NPC Distance
constexpr float c_fDefaultNpcDistance = 10000.0f;
constexpr float c_fMinNpcDistance = 2500.0f;
constexpr float c_fMaxNpcDistance = 10000.0f;

//STONE Distance
constexpr float c_fDefaultStoneDistance = 10000.0f;
constexpr float c_fMinStoneDistance = 2500.0f;
constexpr float c_fMaxStoneDistance = 10000.0f;

//PET Distance
constexpr float c_fDefaultPetDistance = 5000.0f;
constexpr float c_fMinPetDistance = 0.0f;
constexpr float c_fMaxPetDistance = 10000.0f;

//MOUNT Distance
constexpr float c_fDefaultMountDistance = 5000.0f;
constexpr float c_fMinMountDistance = 0.0f;
constexpr float c_fMaxMountDistance = 10000.0f;

//MOB Distance
constexpr float c_fDefaultMobDistance = 10000.0f;
constexpr float c_fMinMobDistance = 2500.0f;
constexpr float c_fMaxMobDistance = 10000.0f;

//TEXT Distance
constexpr float c_fDefaultTextDistance = 1000.0f;
constexpr float c_fMinTextDistance = 0.0f;
constexpr float c_fMaxTextDistance = 10000.0f;

//EFFECT Distance
constexpr float c_fDefaultEFFECTDistance = 7000.0f;
constexpr float c_fMinEffectDistance = 0.0f;
constexpr float c_fMaxEffectDistance = 10000.0f;

//Stone Scale
constexpr float c_fDefaultStoneScale = 100.0f;
constexpr float c_fMinStoneScale = 100.0f;
constexpr float c_fMaxStoneScale = 200.0f;

//Boss Scale
constexpr float c_fDefaultBossScale = 100.0f;
constexpr float c_fMinBossScale = 100.0f;
constexpr float c_fMaxBossScale = 150.0f;

//Mount Scale
constexpr float c_fDefaultMountScale = 50.0f;
constexpr float c_fMinMountScale = 50.0f;
constexpr float c_fMaxMountScale = 100.0f;
#endif
...
#ifndef DISABLE_POST_PROCESSING
	protected:
		CPostProcessingChain m_kPostProcessingChain;

	public:
		inline CPostProcessingChain& GetPostProcessingChain() { return m_kPostProcessingChain; }
#endif
};
