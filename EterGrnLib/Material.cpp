...
{
	static float SPECULAR_TRANSLATE_MAX = 100.0f;
...
void CGrannyMaterial::MapTextureReflection()
{
	//disabled
}
...
void CGrannyMaterial::__ApplySpecularRenderState()
{
	...
	STATEMANAGER.SaveTextureStageState(3, D3DTSS_TEXCOORDINDEX, D3DTSS_TCI_CAMERASPACEREFLECTIONVECTOR);
	...
	STATEMANAGER.SetTextureStageState(3, D3DTSS_COLORARG1, D3DTA_CURRENT);
	STATEMANAGER.SetTextureStageState(3, D3DTSS_COLORARG2, D3DTA_TEXTURE);
	STATEMANAGER.SetTextureStageState(3, D3DTSS_COLOROP, D3DTOP_MODULATEALPHA_ADDCOLOR);
	STATEMANAGER.SetTextureStageState(3, D3DTSS_ALPHAARG1, D3DTA_CURRENT);
	STATEMANAGER.SetTextureStageState(3, D3DTSS_ALPHAOP, D3DTOP_SELECTARG1);

	STATEMANAGER.SetTransform(D3DTS_TEXTURE2, &ms_matSpecular);
	STATEMANAGER.SaveTextureStageState(3, D3DTSS_TEXTURETRANSFORMFLAGS, D3DTTFF_COUNT2);
#ifdef DIRECTX9
	STATEMANAGER.SaveSamplerState(3, D3DSAMP_ADDRESSU, D3DTADDRESS_WRAP);
	STATEMANAGER.SaveSamplerState(3, D3DSAMP_ADDRESSV, D3DTADDRESS_WRAP);
#else
...
{
	SAFE_RELEASE(TextureReflectionMap);
	SAFE_RELEASE(TextureReflectionMap2);
	...
	STATEMANAGER.RestoreTextureStageState(3, D3DTSS_TEXTURETRANSFORMFLAGS);
#ifdef DIRECTX9
	STATEMANAGER.RestoreSamplerState(3, D3DSAMP_ADDRESSU);
	STATEMANAGER.RestoreSamplerState(3, D3DSAMP_ADDRESSV);
#else
	STATEMANAGER.RestoreTextureStageState(1, D3DTSS_ADDRESSU);
	STATEMANAGER.RestoreTextureStageState(1, D3DTSS_ADDRESSV);
#endif

	STATEMANAGER.RestoreTextureStageState(3, D3DTSS_TEXCOORDINDEX);
	STATEMANAGER.SetTextureStageState(3, D3DTSS_COLOROP, D3DTOP_DISABLE);
	STATEMANAGER.SetTextureStageState(3, D3DTSS_ALPHAOP, D3DTOP_DISABLE);
